...
protocol: "Derive"
title: "Parameters"
source: "https://docs.derive.xyz/docs/parameters"
crawled_at: "2026-07-26T22:45:02+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/parameters#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/parameters)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/parameters)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Parameters
Search
CTRL-K
## Introduction
...
# Parameters
  1. [Asset Parameters](https://docs.lyra.finance/docs/asset-parameters-1) 2. [Common Parameters](https://docs.lyra.finance/docs/common-parameters) 3. [Standard Margin Parameters](https://docs.lyra.finance/docs/standard-manager-parameters) 4. [Portfolio Margin Parameters](https://docs.lyra.finance/docs/portfolio-margin-parameters-1)

  

Updated 10 months ago
* * *
[PM2](https://docs.derive.xyz/docs/pm2)[Asset Parameters](https://docs.derive.xyz/docs/asset-parameters-1)
