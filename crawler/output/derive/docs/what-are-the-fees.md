...
source: "https://docs.derive.xyz/docs/what-are-the-fees"
crawled_at: "2026-07-26T22:45:33+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/what-are-the-fees#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-are-the-fees)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-are-the-fees)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)What are the fees?
Search
CTRL-K
## Introduction
...
[](https://docs.derive.xyz/docs/what-are-the-fees#what-are-the-fees-to-trade-on-derive)
...
[](https://docs.derive.xyz/docs/what-are-the-fees#what-are-the-fees-if-i-get-liquidated)
...
## 
Other Fees
[](https://docs.derive.xyz/docs/what-are-the-fees#other-fees)
...
* * *
[How to Deposit HYPE](https://docs.derive.xyz/docs/how-to-deposit-hype)[Standard Margin](https://docs.derive.xyz/docs/standard-margin)
Did this page help you?
Yes
No
Copy Page
  *     * [What are the fees to trade on Derive?](https://docs.derive.xyz/docs/what-are-the-fees#what-are-the-fees-to-trade-on-derive)
    * [What are the fees if I get liquidated?](https://docs.derive.xyz/docs/what-are-the-fees#what-are-the-fees-if-i-get-liquidated)
    * [Other Fees](https://docs.derive.xyz/docs/what-are-the-fees#other-fees)
