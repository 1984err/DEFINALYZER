---
protocol: "Derive"
title: "Expiration & Settlement"
source: "https://docs.derive.xyz/docs/expiration-settlement"
crawled_at: "2026-07-26T22:44:35+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/expiration-settlement#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/expiration-settlement)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/expiration-settlement)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Expiration & Settlement
Search
CTRL-K
## Introduction
...
* * *
[What happens if USDC depegs from $1?](https://docs.derive.xyz/docs/what-happens-if-usdc-depegs-from-1)[How are strikes and expiries selected?](https://docs.derive.xyz/docs/how-are-strikes-and-expiries-selected)
