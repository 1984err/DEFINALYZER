---
protocol: "Derive"
title: "Maxi Execution"
source: "https://docs.derive.xyz/docs/maxi-execution"
crawled_at: "2026-07-26T22:44:56+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/maxi-execution#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/maxi-execution)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/maxi-execution)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Maxi Execution
Search
CTRL-K
## Introduction
...
# Maxi Execution
  ...
  3. [Maxi Vaults](https://help.derive.xyz/en/collections/10364728-maxi-vaults)
  4. Maxi Execution
...
## 
TLDR
[](https://docs.derive.xyz/docs/maxi-execution#tldr)
## 
Vault Positions Lifecycle
[](https://docs.derive.xyz/docs/maxi-execution#vault-positions-lifecycle)
The Vault positions go through the following stages:
## 
Stage 1 - Only Collateral
[](https://docs.derive.xyz/docs/maxi-execution#stage-1---only-collateral)
...
[](https://docs.derive.xyz/docs/maxi-execution#stage-2---option-rfq-auction)
## 
Stage 3 - Await Option Settlement
[](https://docs.derive.xyz/docs/maxi-execution#stage-3---await-option-settlement)
...
[](https://docs.derive.xyz/docs/maxi-execution#stage-4---collateral-limit-order-auction)
...
[](https://docs.derive.xyz/docs/maxi-execution#smart-contract-strategy-mandate-enforcement)
...
A Vault has to go through the same flow, except the session key it uses are not
...
* * *
[Maxi Strategy](https://docs.derive.xyz/docs/maxi-strategy)[Maxi Risks](https://docs.derive.xyz/docs/maxi-risks)
Did this page help you?
Yes
No
Copy Page
  *     * [TLDR](https://docs.derive.xyz/docs/maxi-execution#tldr)
    * [Vault Positions Lifecycle](https://docs.derive.xyz/docs/maxi-execution#vault-positions-lifecycle)
    * [Stage 1 - Only Collateral](https://docs.derive.xyz/docs/maxi-execution#stage-1---only-collateral)
    * [Stage 2 - Option RFQ Auction](https://docs.derive.xyz/docs/maxi-execution#stage-2---option-rfq-auction)
    * [Stage 3 - Await Option Settlement](https://docs.derive.xyz/docs/maxi-execution#stage-3---await-option-settlement)
    * [Stage 4 - Collateral Limit Order Auction](https://docs.derive.xyz/docs/maxi-execution#stage-4---collateral-limit-order-auction)
    * [Smart Contract Strategy Mandate Enforcement](https://docs.derive.xyz/docs/maxi-execution#smart-contract-strategy-mandate-enforcement)
