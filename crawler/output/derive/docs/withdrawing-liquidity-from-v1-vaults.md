---
protocol: "Derive"
title: "Withdrawing Liquidity from V1 Vaults"
source: "https://docs.derive.xyz/docs/withdrawing-liquidity-from-v1-vaults"
crawled_at: "2026-07-26T22:45:45+00:00"
---

# Withdrawing Liquidity from V1 Vaults
...
[Jump to Content](https://docs.derive.xyz/docs/withdrawing-liquidity-from-v1-vaults#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/withdrawing-liquidity-from-v1-vaults)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/withdrawing-liquidity-from-v1-vaults)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Withdrawing Liquidity from V1 Vaults
Search
CTRL-K
## Introduction
...
# Withdrawing Liquidity from V1 Vaults
  ...
  2. [Migration](https://help.derive.xyz/en/collections/9434784-migration)
  3. Withdrawing Liquidity from V1 Vaults


## 
Steps to Withdraw
[](https://docs.derive.xyz/docs/withdrawing-liquidity-from-v1-vaults#steps-to-withdraw)
[![](https://lyra-91b1905e536e.intercom-attachments-7.com/i/o/1051144861/fb764073fecdcb54428c2864/image?expires=1777060800&signature=f62315a67a497ce73a468e5e26788f670848b27e309ef05e7ac49d82e82c1999&req=dSAiF8h6mYlZWPMW1HO4zY71gKtqpiCbqJjzwZE8Vo%2Fz0mgJq6goFc6xec1b%0A%2FaVG0eG%2FQZBtnBD9Zcg%3D%0A)](https://lyra-91b1905e536e.intercom-attachments-7.com/i/o/1051144861/fb764073fecdcb54428c2864/image?expires=1777060800&signature=f62315a67a497ce73a468e5e26788f670848b27e309ef05e7ac49d82e82c1999&req=dSAiF8h6mYlZWPMW1HO4zY71gKtqpiCbqJjzwZE8Vo%2Fz0mgJq6goFc6xec1b%0A%2FaVG0eG%2FQZBtnBD9Zcg%3D%0A)
Step 1[here](https://optimistic.etherscan.io/address/0x5Db73886c4730dBF3C562ebf8044E19E8C93843e#writeContract) to access the contract.
Click the drop-down below to select the Liquidity Pool contract of a different vault.
Step 2Connect to Web3
Step 3initiateWithdraw
Step 4beneficiaryamountLiquidityToken
A. Beneficiary: Input your wallet address (i.e., 0x...)
B. amountLiquidityToken: Input the number of tokens to withdraw, click the plus icon to add zeroes, choose 10^18 from the menu, and select ''Add''.
Step 5Write
* * *
...
No
Copy Page
  *     * [Steps to Withdraw](https://docs.derive.xyz/docs/withdrawing-liquidity-from-v1-vaults#steps-to-withdraw)
