---
protocol: "Derive"
title: "What is Derive?"
source: "https://docs.derive.xyz/docs/what-is-derive-1"
crawled_at: "2026-07-26T22:45:37+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/what-is-derive-1#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-is-derive-1)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-is-derive-1)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)What is Derive?
Search
CTRL-K
## Introduction
...
## 
Cross-Margin
[](https://docs.derive.xyz/docs/what-is-derive-1#cross-margin)
...
[](https://docs.derive.xyz/docs/what-is-derive-1#cross-asset-collateral)
Various base assets (e.g., WETH, WBTC) can be used as collateral for perps and options positions, allowing users to:
## 
Portfolio Margin
[](https://docs.derive.xyz/docs/what-is-derive-1#portfolio-margin)
...
* * *
[Staking Rewards Program](https://docs.derive.xyz/docs/staking-rewards-program)[How do I know my funds are safe?](https://docs.derive.xyz/docs/how-do-i-know-my-funds-are-safe)
Did this page help you?
Yes
No
Copy Page
  *     * [Cross-Margin](https://docs.derive.xyz/docs/what-is-derive-1#cross-margin)
    * [Cross-Asset Collateral](https://docs.derive.xyz/docs/what-is-derive-1#cross-asset-collateral)
    * [Portfolio Margin](https://docs.derive.xyz/docs/what-is-derive-1#portfolio-margin)
