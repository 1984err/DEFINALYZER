---
protocol: "Derive"
title: "Delta-1 Basis Risks"
source: "https://docs.derive.xyz/docs/delta-1-basis-risks"
crawled_at: "2026-07-26T22:44:28+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/delta-1-basis-risks#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/delta-1-basis-risks)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/delta-1-basis-risks)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Delta-1 Basis Risks
Search
CTRL-K
## Introduction
...
# Delta-1 Basis Risks
There are a few risks associated with tokenized strategies - beyond the risk of the strategy itself (detailed [here](https://help.derive.xyz/en/articles/10732523-delta-1-basis-strategy)). It is important users are aware of these risks before depositing to or acquiring a tokenized strategy. Note that this is not necessarily an exhaustive list.
## 
Execution Risks
[](https://docs.derive.xyz/docs/delta-1-basis-risks#execution-risks)
## 
Restaked Asset Depeg Risk
[](https://docs.derive.xyz/docs/delta-1-basis-risks#restaked-asset-depeg-risk)
...
## 
Liquidity Risks
[](https://docs.derive.xyz/docs/delta-1-basis-risks#liquidity-risks)
...
## 
Oracle Risks
[](https://docs.derive.xyz/docs/delta-1-basis-risks#oracle-risks)
Per the Derive [docs](https://docs.lyra.finance/docs/oracles-1), for each market, there is a set of oracle inputs used for marking assets when computing margin and liquidations. This data is posted onchain for transparency and available via the public REST API. This data is provided by [Block Scholes](https://www.blockscholes.com/) and several other partners.
...
[](https://docs.derive.xyz/docs/delta-1-basis-risks#underlying-collateral-risks)
...
## 
Bridge Risk
[](https://docs.derive.xyz/docs/delta-1-basis-risks#bridge-risk)
Transferring assets from one network to another carries risks associated with the underlying bridge provider. In this product, we use Socket as the bridge provider. Please review their [documentation](https://docs.socket.tech/introduction) for more details.
## 
Smart Contract Risk
[](https://docs.derive.xyz/docs/delta-1-basis-risks#smart-contract-risk)
...
* * *
[Delta-1 Basis Execution](https://docs.derive.xyz/docs/delta-1-basis-execution)[Harvest Strategy](https://docs.derive.xyz/docs/harvest-strategy)
Did this page help you?
Yes
No
Copy Page
  *     * [Execution Risks](https://docs.derive.xyz/docs/delta-1-basis-risks#execution-risks)
    * [Restaked Asset Depeg Risk](https://docs.derive.xyz/docs/delta-1-basis-risks#restaked-asset-depeg-risk)
    * [Liquidity Risks](https://docs.derive.xyz/docs/delta-1-basis-risks#liquidity-risks)
    * [Oracle Risks](https://docs.derive.xyz/docs/delta-1-basis-risks#oracle-risks)
    * [Underlying Collateral Risks](https://docs.derive.xyz/docs/delta-1-basis-risks#underlying-collateral-risks)
    * [Bridge Risk](https://docs.derive.xyz/docs/delta-1-basis-risks#bridge-risk)
    * [Smart Contract Risk](https://docs.derive.xyz/docs/delta-1-basis-risks#smart-contract-risk)
