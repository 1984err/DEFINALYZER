...
protocol: "Derive"
title: "About Derive"
source: "https://docs.derive.xyz/docs/about-derive"
crawled_at: "2026-07-26T22:44:07+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/about-derive#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/about-derive)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/about-derive)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)About Derive
Search
CTRL-K
## Introduction
...
Derive is a self-custodial, high performance cryptocurrency trading platform for options, perpetuals and spot trading. The platform is made up of three components:
  1. Derive Chain:[OP Stack](https://stack.optimism.io/), secured by Ethereum mainnet. Governed by the [Derive DAO](https://docs.lyra.finance/docs/dao-governance-overview).
  2. Derive Protocol:[Derive DAO](https://docs.lyra.finance/docs/dao-governance-overview).
  3. Derive Exchange:
...
> [](https://docs.derive.xyz/docs/about-derive#the-derive-exchange-uses-a-centralized-limit-order-book-but-remains-self-custodial-and-settles-trades-and-liquidations-in-a-trustless-manner)
