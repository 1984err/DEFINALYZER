...
source: "https://docs.derive.xyz/docs/what-networks-are-supported"
crawled_at: "2026-07-26T22:45:38+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/what-networks-are-supported#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-networks-are-supported)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-networks-are-supported)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)What networks are supported?
Search
CTRL-K
## Introduction
...
# What networks are supported?
  ...
  2. [Accounts](https://help.derive.xyz/en/collections/7340313-accounts)
  3. What networks are supported?


Updated this week
Table of contents
Derive supports cross-chain deposits, meaning you can deposit collateral from various networks to Derive on Derive Chain. Derive Chain is a separate network, but you'll never have to switch your wallet to it.
## 
Supported Networks
[](https://docs.derive.xyz/docs/what-networks-are-supported#supported-networks)
The networks you can deposit collateral from are the following:
  * Ethereum
  * Arbitrum
  * Optimism
  * Base
...
* * *
[What wallets are supported? ](https://docs.derive.xyz/docs/what-wallets-are-supported)[What bridge does Derive use?](https://docs.derive.xyz/docs/what-bridge-does-derive-use)
Did this page help you?
Yes
No
Copy Page
  *     * [Supported Networks](https://docs.derive.xyz/docs/what-networks-are-supported#supported-networks)
