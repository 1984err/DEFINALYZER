---
protocol: "Derive"
title: "Why do I need to enable spending?"
source: "https://docs.derive.xyz/docs/why-do-i-need-to-enable-spending"
crawled_at: "2026-07-26T22:45:43+00:00"
---

# Why do I need to enable spending?
...
[Jump to Content](https://docs.derive.xyz/docs/why-do-i-need-to-enable-spending#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/why-do-i-need-to-enable-spending)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/why-do-i-need-to-enable-spending)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Why do I need to enable spending?
Search
CTRL-K
## Introduction
...
## 
Permit Signatures
[](https://docs.derive.xyz/docs/why-do-i-need-to-enable-spending#permit-signatures)
...
Permits also strengthen security with options such as time-bound approvals. Learn more about permit signatures and their key features [here](https://blog.uniswap.org/permit2-and-universal-router).
* * *
  

Updated 3 months ago
* * *
[Why do I need to enable Derive?](https://docs.derive.xyz/docs/why-do-i-need-to-enable-derive)[What wallets are supported? ](https://docs.derive.xyz/docs/what-wallets-are-supported)
Did this page help you?
Yes
No
Copy Page
  *     * [Permit Signatures](https://docs.derive.xyz/docs/why-do-i-need-to-enable-spending#permit-signatures)
