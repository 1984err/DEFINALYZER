...
source: "https://docs.derive.xyz/docs/service-providers"
crawled_at: "2026-07-26T22:45:18+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/service-providers#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/service-providers)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/service-providers)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Service Providers
Search
CTRL-K
## Introduction
...
Service providers play a crucial role in the growth and maintenance of the Derive ecosystem. Any individual or group can apply to become a service provider to the Derive DAO by submitting a proposal to the governance system.
# 
Becoming a Service Provider
[](https://docs.derive.xyz/docs/service-providers#becoming-a-service-provider)
...
[](https://docs.derive.xyz/docs/service-providers#review-and-approval-process)
...
By ensuring a transparent and accountable process, Derive DAO encourages the development of a diverse and robust ecosystem of service providers, fostering innovation and collaboration within the community.
Updated 10 months ago
* * *
[Treasury](https://docs.derive.xyz/docs/treasury)[Retail Trading Rewards Program](https://docs.derive.xyz/docs/retail-trading-rewards-program)
Did this page help you?
Yes
No
Copy Page
  *     * [Becoming a Service Provider](https://docs.derive.xyz/docs/service-providers#becoming-a-service-provider)
    * [Review and Approval Process](https://docs.derive.xyz/docs/service-providers#review-and-approval-process)
