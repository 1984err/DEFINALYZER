---
protocol: "Derive"
title: "What happens if USDC depegs from $1?"
source: "https://docs.derive.xyz/docs/what-happens-if-usdc-depegs-from-1"
crawled_at: "2026-07-26T22:45:36+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/what-happens-if-usdc-depegs-from-1#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-happens-if-usdc-depegs-from-1)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-happens-if-usdc-depegs-from-1)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)What happens if USDC depegs from $1?
Search
CTRL-K
## Introduction
...
* * *
[Borrowing & Lending](https://docs.derive.xyz/docs/borrowing-lending)[Expiration & Settlement](https://docs.derive.xyz/docs/expiration-settlement)
