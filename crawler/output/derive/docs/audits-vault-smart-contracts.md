---
protocol: "Derive"
title: "Audits Vault Smart Contracts"
source: "https://docs.derive.xyz/docs/audits-vault-smart-contracts"
crawled_at: "2026-07-26T22:44:10+00:00"
---

# Audits Vault Smart Contracts
...
[Jump to Content](https://docs.derive.xyz/docs/audits-vault-smart-contracts#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/audits-vault-smart-contracts)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/audits-vault-smart-contracts)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Audits Vault Smart Contracts
Search
CTRL-K
## Introduction
...
# Audits Vault Smart Contracts
  ...
  3. [Smart Contracts & Audits](https://help.derive.xyz/en/collections/10249130-smart-contracts-audits)
  4. Audits Vault Smart Contracts


The contracts for the tokenized vault strategies have been audited by [Sigma Prime](https://sigmaprime.io/). View the audit reports [here](https://github.com/sigp/public-audits/tree/master/reports/derive).
* * *
  

Updated 3 months ago
* * *
[Vault Smart Contracts ](https://docs.derive.xyz/docs/vault-smart-contracts)[DRV](https://docs.derive.xyz/docs/drv)
