---
protocol: "Derive"
title: "Why do I need to enable Derive?"
source: "https://docs.derive.xyz/docs/why-do-i-need-to-enable-derive"
crawled_at: "2026-07-26T22:45:42+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/why-do-i-need-to-enable-derive#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/why-do-i-need-to-enable-derive)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/why-do-i-need-to-enable-derive)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Why do I need to enable Derive?
Search
CTRL-K
## Introduction
...
Users can also revoke their session keys at any time on the Developers page.
* * *
  

Updated 3 months ago
* * *
[The Greeks ](https://docs.derive.xyz/docs/the-greeks)[Why do I need to enable spending?](https://docs.derive.xyz/docs/why-do-i-need-to-enable-spending)
