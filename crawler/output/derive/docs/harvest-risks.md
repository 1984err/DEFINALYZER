...
protocol: "Derive"
title: "Harvest Risks"
source: "https://docs.derive.xyz/docs/harvest-risks"
crawled_at: "2026-07-26T22:44:40+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/harvest-risks#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/harvest-risks)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/harvest-risks)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Harvest Risks
Search
CTRL-K
## Introduction
...
# Harvest Risks
There are a few risks associated with tokenized strategies - beyond the risk of the strategy itself (detailed [here](https://help.lyra.finance/en/articles/9351620-covered-call-strategy-explainer)). It is important users are aware of these risks before depositing to or acquiring a tokenized strategy. Note that this is not necessarily an exhaustive list.
## 
Execution Risks
[](https://docs.derive.xyz/docs/harvest-risks#execution-risks)
Delayed settlement
Oracle Risk
## 
Underlying Collateral Risk
[](https://docs.derive.xyz/docs/harvest-risks#underlying-collateral-risk)
...
## 
Bridge Risk
[](https://docs.derive.xyz/docs/harvest-risks#bridge-risk)
## 
Smart Contract Risk
[](https://docs.derive.xyz/docs/harvest-risks#smart-contract-risk)
* * *
  

Updated 3 months ago
* * *
[Harvest Execution](https://docs.derive.xyz/docs/harvest-execution)[Safe Harvest Strategy](https://docs.derive.xyz/docs/safe-harvest-strategy)
Did this page help you?
Yes
No
Copy Page
  *     * [Execution Risks](https://docs.derive.xyz/docs/harvest-risks#execution-risks)
    * [Underlying Collateral Risk](https://docs.derive.xyz/docs/harvest-risks#underlying-collateral-risk)
    * [Bridge Risk](https://docs.derive.xyz/docs/harvest-risks#bridge-risk)
    * [Smart Contract Risk](https://docs.derive.xyz/docs/harvest-risks#smart-contract-risk)
