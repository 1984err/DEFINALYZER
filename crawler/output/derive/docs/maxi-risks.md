...
protocol: "Derive"
title: "Maxi Risks"
source: "https://docs.derive.xyz/docs/maxi-risks"
crawled_at: "2026-07-26T22:44:57+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/maxi-risks#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/maxi-risks)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/maxi-risks)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Maxi Risks
Search
CTRL-K
## Introduction
...
# Maxi Risks
There are a few risks associated with tokenized strategies - beyond the risk of the strategy itself (detailed [here](https://help.derive.xyz/en/articles/9823406-covered-put-spread-strategy)). It is important users are aware of these risks before depositing to or acquiring a tokenized strategy. Note that this is not necessarily an exhaustive list.
## 
Execution Risks
[](https://docs.derive.xyz/docs/maxi-risks#execution-risks)
Delayed Settlement
Oracle Risks
## 
Underlying Collateral Risk
[](https://docs.derive.xyz/docs/maxi-risks#underlying-collateral-risk)
...
## 
Bridge Risk
[](https://docs.derive.xyz/docs/maxi-risks#bridge-risk)
...
## 
Smart Contract Risk
[](https://docs.derive.xyz/docs/maxi-risks#smart-contract-risk)
...
* * *
[Maxi Execution](https://docs.derive.xyz/docs/maxi-execution)[BULL Strategy ](https://docs.derive.xyz/docs/bull-strategy)
Did this page help you?
Yes
No
Copy Page
  *     * [Execution Risks](https://docs.derive.xyz/docs/maxi-risks#execution-risks)
    * [Underlying Collateral Risk](https://docs.derive.xyz/docs/maxi-risks#underlying-collateral-risk)
    * [Bridge Risk](https://docs.derive.xyz/docs/maxi-risks#bridge-risk)
    * [Smart Contract Risk](https://docs.derive.xyz/docs/maxi-risks#smart-contract-risk)
