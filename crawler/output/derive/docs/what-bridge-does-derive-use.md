---
protocol: "Derive"
title: "What bridge does Derive use?"
source: "https://docs.derive.xyz/docs/what-bridge-does-derive-use"
crawled_at: "2026-07-26T22:45:34+00:00"
---

# What bridge does Derive use?
...
[Jump to Content](https://docs.derive.xyz/docs/what-bridge-does-derive-use#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-bridge-does-derive-use)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/what-bridge-does-derive-use)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)What bridge does Derive use?
Search
CTRL-K
## Introduction
...
# What bridge does Derive use?
Derive uses a custom bridge that uses [Socket](https://socket.tech/) smart contracts and L1-L2 messaging infrastructure. This enables a fast bridge and has the option for fast withdrawals that aren't subject to the 7-day challenge period. To preserve the self-custody guarantees of fraud proofs, there are global daily fast withdrawal limits.
Depending on the asset, users can deposit and withdraw to and from Ethereum, Arbitrum, Optimism, and Base. Learn more about the supported networks [here](https://help.lyra.finance/en/articles/9085623-what-networks-are-supported).
## 
Why do bridges take 2-10 minutes?
[](https://docs.derive.xyz/docs/what-bridge-does-derive-use#why-do-bridges-take-2-10-minutes)
Depositing to and from Derive takes 2-5 minutes on an L2 (Arbitrum, Optimism, Base) and 5-10 minutes on Ethereum mainnet. This delay is due to messages being relayed between the blockchains to safely confirm deposits on Derive Chain.
* * *
  

Updated 3 months ago
* * *
[What networks are supported?](https://docs.derive.xyz/docs/what-networks-are-supported)[How to Deposit HYPE](https://docs.derive.xyz/docs/how-to-deposit-hype)
Did this page help you?
Yes
No
Copy Page
  *     * [Why do bridges take 2-10 minutes?](https://docs.derive.xyz/docs/what-bridge-does-derive-use#why-do-bridges-take-2-10-minutes)
