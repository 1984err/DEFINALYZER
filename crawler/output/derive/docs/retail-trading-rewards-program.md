---
protocol: "Derive"
title: "Retail Trading Rewards Program"
source: "https://docs.derive.xyz/docs/retail-trading-rewards-program"
crawled_at: "2026-07-26T22:45:09+00:00"
---

# Retail Trading Rewards Program
...
[Jump to Content](https://docs.derive.xyz/docs/retail-trading-rewards-program#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/retail-trading-rewards-program)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/retail-trading-rewards-program)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)Retail Trading Rewards Program
Search
CTRL-K
## Introduction
...
# 
Program Purpose
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#program-purpose)
The Retail Trading Rewards Program is designed to reward retail traders for their activity on Derive. Whether you trade on our exchange or deposit collateral into our vaults, you can earn rewards in stDRV
  * Incentivize Trading: Reward retail traders for their trading activity on Derive.
  * Enhance Liquidity: Boost overall market liquidity and trading volume on the exchange.
  * Support Growth: Benefit all market participants by aligning rewards with trading fees.


* * *
# 
Program Scope
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#program-scope)
  * Exchange Trading: Earn rewards when trading on derive.xyz/trade.
  * Vault Deposits: Earn rewards when depositing collateral into vaults via derive.xyz/earn.


* * *
# 
Reward Tokens
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#reward-tokens)
  * Rewards are paid out in stDRV.
  * The reward amounts are updated weekly and can be viewed at [derive.xyz/rewards](https://app.derive.xyz/rewards).


* * *
# 
Eligibility
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#eligibility)
  * Who Can Participate: The program is open to all retail traders. There is no application process, simply start trading or depositing collateral to qualify.
  * Fair Participation: Rewards are distributed on a pro-rata basis according to the fees you pay. All trading activity is subject to an audit before rewards are finalized. Behavior that violates the ToS is strictly prohibited and will result in disqualification.


* * *
# 
How To Earn Rewards
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#how-to-earn-rewards)
  * Exchange Trading: Your maker and taker fees are collected into a rewards pool.  
At the end of each weekly epoch, rewards are allocated proportionally based on the fees you paid.
  * Vault Deposits: Depositing collateral into the vaults qualifies you for rewards.  
In some cases, vault-related trades may receive fee boosts as an extra incentive.


* * *
# 
Reward Distribution
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#reward-distribution)
  * Rewards are calculated, audited, and paid out on a weekly basis. Typically, rewards are paid out one week after the epoch ends.
  * The updated reward amounts and your earned rewards can be tracked in real time at [derive.xyz/rewards](https://app.derive.xyz/rewards).


* * *
# 
Trading Fees and Rewards
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#trading-fees-and-rewards)
  * Fee Structure: Derive employs a maker/taker fee model. Your trading fees contribute to the rewards pool.
  * Pro-Rata Allocation: Rewards are distributed based on the proportion of fees you contribute relative to the total fees collected.
  * Audit Process: All reward distributions are verified through an audit process each week to ensure fairness and transparency.


* * *
# 
Getting Started
[](https://docs.derive.xyz/docs/retail-trading-rewards-program#getting-started)
  1. Trade or Deposit
...
* * *
[Service Providers](https://docs.derive.xyz/docs/service-providers)[Institutional Trading Rewards Program](https://docs.derive.xyz/docs/institutional-trading-rewards-program-1)
Did this page help you?
Yes
No
Copy Page
  *     * [Program Purpose](https://docs.derive.xyz/docs/retail-trading-rewards-program#program-purpose)
    * [Program Scope](https://docs.derive.xyz/docs/retail-trading-rewards-program#program-scope)
    * [Reward Tokens](https://docs.derive.xyz/docs/retail-trading-rewards-program#reward-tokens)
    * [Eligibility](https://docs.derive.xyz/docs/retail-trading-rewards-program#eligibility)
    * [How To Earn Rewards](https://docs.derive.xyz/docs/retail-trading-rewards-program#how-to-earn-rewards)
    * [Reward Distribution](https://docs.derive.xyz/docs/retail-trading-rewards-program#reward-distribution)
    * [Trading Fees and Rewards](https://docs.derive.xyz/docs/retail-trading-rewards-program#trading-fees-and-rewards)
    * [Getting Started](https://docs.derive.xyz/docs/retail-trading-rewards-program#getting-started)
