---
protocol: "Derive"
title: "How are strikes and expiries selected?"
source: "https://docs.derive.xyz/docs/how-are-strikes-and-expiries-selected"
crawled_at: "2026-07-26T22:44:44+00:00"
---

# How are strikes and expiries selected?
...
[Jump to Content](https://docs.derive.xyz/docs/how-are-strikes-and-expiries-selected#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/how-are-strikes-and-expiries-selected)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/how-are-strikes-and-expiries-selected)
v2.2
[Home](https://docs.derive.xyz/)[Documentation](https://docs.derive.xyz/docs)[API Reference](https://docs.derive.xyz/reference)How are strikes and expiries selected?
Search
CTRL-K
## Introduction
...
# How are strikes and expiries selected?
  ...
  2. [Trading](https://help.derive.xyz/en/collections/7340291-trading)
  3. [Options](https://help.derive.xyz/en/collections/7340481-options)
  4. How are strikes and expiries selected?


## 
Expiries
[](https://docs.derive.xyz/docs/how-are-strikes-and-expiries-selected#expiries)
You can trade Daily, Weekly, and Monthly expiries on Derive. The current schedule consists of the following listings:
  * 2 Daily expiries.
  * 3 Weekly expiries.
  * 3 Monthly expiries.


When one of the listed Dailies, Weeklies, or Monthlies expires, a new one will be added.
## 
Strikes
[](https://docs.derive.xyz/docs/how-are-strikes-and-expiries-selected#strikes)
The strike increments depend on the delta and the time left to expiry:
  * Ethereum (ETH)

  
| Time to Expiry  | Delta  | Increments ($)  |  
| --- | --- | --- |  
| 1 day or less  | 40-60  | 25  |  
|   | 20-40, 60-80  | 50  |  
|   | 1-20, 80-99  | 100  |  
| 8 days or less  | 40-60  | 50  |  
|   | 20-40, 60-80  | 100  |  
|   | 1-20, 80-99  | 200  |  
| 35 days or less  | 40-60  | 100  |  
|   | 20-40, 60-80  | 200  |  
|   | 1-20, 80-99  | 500  |  
| More than 35 days  | 40-60  | 200  |  
|   | 20-40, 60-80  | 500  |  
|   | 1-20, 80-99  | 1000  |  
  * Bitcoin (BTC)
...
| Time to Expiry  | Delta  | Increments ($)  |  
| --- | --- | --- |  
| 1 day or less  | 40-60  | 500  |  
|   | 20-40, 60-80  | 1000  |  
|   | 1-20, 80-99  | 2000  |  
| 8 days or less  | 40-60  | 1000  |  
|   | 20-40, 60-80  | 2000  |  
|   | 1-20, 80-99  | 5000  |  
| 35 days or less  | 40-60  | 2000  |  
|   | 20-40, 60-80  | 5000  |  
|   | 1-20, 80-99  | 10000  |  
| More than 35 days  | 40-60  | 5000  |  
|   | 20-40, 60-80  | 10000  |  
|   | 1-20, 80-99  | 20000  |  
* * *
...
* * *
[Expiration & Settlement](https://docs.derive.xyz/docs/expiration-settlement)[Funding Rates](https://docs.derive.xyz/docs/funding-rates)
Did this page help you?
Yes
No
Copy Page
  *     * [Expiries](https://docs.derive.xyz/docs/how-are-strikes-and-expiries-selected#expiries)
    * [Strikes](https://docs.derive.xyz/docs/how-are-strikes-and-expiries-selected#strikes)
