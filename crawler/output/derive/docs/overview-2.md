...
protocol: "Derive"
title: "Overview"
source: "https://docs.derive.xyz/docs/overview-2"
crawled_at: "2026-07-26T22:45:01+00:00"
---
...
[Jump to Content](https://docs.derive.xyz/docs/overview-2#content)
...
* * *
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/overview-2)[![Derive](https://files.readme.io/97584af-brandmark-white.svg)](https://docs.derive.xyz/)
Documentation
[Log In](https://docs.derive.xyz/login?redirect_uri=/docs/overview-2)
v2.2
...
* * *
[About Derive](https://docs.derive.xyz/docs/about-derive)[Derive Chain](https://docs.derive.xyz/docs/lyra-chain)
